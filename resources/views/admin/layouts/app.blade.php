...
<body>
    ...
    <div class="content-wrapper">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar fixed-top mb-4 shadow-sm">
            ...
            <!-- Topbar Brand -->
            <a class="navbar-brand d-md-none" href="{{ route('admin.dashboard') }}">Admin Panel</a>
            ...
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item dropdown user-dropdown no-arrow">
                    <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                        <span class="user-name-text d-none d-lg-inline text-gray-600 small me-2">{{ Auth::guard('admin')->user()->name }}</span>
                        <img class="img-profile rounded-circle" src="https://ui-avatars.com/api/?name={{ Auth::guard('admin')->user()->name }}&background=4e73df&color=ffffff">
                    </a>
                    ...
                    <div class="dropdown-menu dropdown-menu-end shadow animated--grow-in" aria-labelledby="userDropdown">
                        ...
                        <a class="dropdown-item" href="#">
                            <i class="fas fa-cogs fa-sm fa-fw text-gray-400 me-2"></i>
                            Settings
                        </a>
